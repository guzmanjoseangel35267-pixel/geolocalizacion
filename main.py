...
def telegram_webhook():
    data = request.get_json()
    if data and data.get('message', {}).get('text') == '/radar':
        with open(RADAR_FILE, 'w') as f: f.write('activado')
        enviar_telegram("📡 <b>Radar activado.</b> El dispositivo reportará en breve.")
